...
public class Test : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        if (GUILayout.Button("ReportLeaderboard_num"))  //입력
            GPGSBinder.Inst.ReportLeaderboard(GPGSIds.leaderboard_rank, 1000, success => log = $"{success}");

        if (GUILayout.Button("LoadAllLeaderboardArray_num")) //이것보여주기.
        ...
        if (GUILayout.Button("LoadCustomLeaderboardArray_num"))  // 내순위 위주로 
